...
import { View,Linking, ImageBackground, ScrollView, TouchableHighlight, Alert, FlatList, Dimensions, Image, Platform, TouchableOpacity, } from 'react-native'
...
class Connect extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            send_arr: [],
            spinner: false,
            search_text: this.props.route.params && this.props.route.params.header=="Network"?this.props.route.params.tenantId:'',
            area: '',
            business_sector: '',
            business_type: '',
            merchant_id: 0,
    ...
    componentDidMount() {
        if (this.props.route.params &&this.props.route.params.header=="Network") {
...
console.log("working ere")
    ...
    veiwShop(){
        Linking.openURL(`https://${this.state.merchant_id.toLowerCase()}.${Constants.webshop_url}`)
                ...
                <ScrollView>
                    {(this.state.isFound === false) &&
                        ...
                        <View style={[{}, styles.detailContentView]}>
                            ...
                            (
                                <View style={{flexDirection:"row",justifyContent:"flex-start",alignItems:"center",alignSelf:"flex-start",marginLeft:10}}> 
                                 <Image style={{width:35,height:35,marginRight:10}} source={require('../images/bage.png')} />
                            ...
                            <View style={[{}, styles.marchentRow]}>
                                ...
                                <TouchableOpacity onPress={() => this.sendConnectRequest(this.state.merchant_id)} style={[styles.connectBtnNew,{backgroundColor:"#FFE9E9"}]}
>
<Image style={{width:30,height:30}} source={require('../images/connectNet.png')} />
                                  <Text style={{color:"#B1272C",fontWeight:"bold",marginBottom:4,marginTop:4}}>Trade with me</Text>  
                                ...
                                <TouchableOpacity onPress={()=>this.veiwShop()} style={[styles.connectBtnNew,{backgroundColor:"#D5D5E4"}]}
>
<Image style={{width:30,height:30}} source={require('../images/shopNet.png')} />
                                  <Text style={{color:"#2F2E7C",fontWeight:"bold",marginBottom:4,marginTop:4}}>Buy from me</Text>  
                ...
                <ScrollView>
                    <View style={[{}, styles.mainRow]}>
                        <TouchableOpacity
                            ...
                            <Text style={[{ color: '#2F2E7C',marginLeft:10},fontStyles.normal15]}>{this.props.route.params && this.props.route.params.header=="Network"?"NETWORK":'CONNECT'}</Text>
                        </TouchableOpacity>
                    </View>
