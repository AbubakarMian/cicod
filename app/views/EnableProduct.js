      ...
      <Scaffold>
        <View style={[{}, styles.mainView]}>
          ...
          <View style={[{}, styles.backRowView]}>
            ...
            <View style={[{}, styles.backRowHeadingView]}>
              <Text style={[{}, styles.backRowHeadingText]}>
                CONNECT - ENABLE MERCHANT
              </Text>
            </View>
          </View>
          <Text style={[{}, styles.headingDescText]}>
            Select Product category or products you want Merchant to have access
            to
          </Text>
          ...
          <View style={[{}, styles.selectedSmallHeadingView]}>
            ...
            <Text style={[{}, styles.selectedSmallHeadingText]}>
              product selected
            </Text>
          </View>
          <ScrollView>
              ...
              <View style={[{}, styles.modalBackgroundCOntainerView]}>
                <View style={[{}, styles.modalContentCOntainerView]}>
                  ...
                  <View style={[{}, styles.complaintHeadingModalView]}>
                    <Text style={[{}, styles.complaintHeadingModalText]}>
                      Reason
                    </Text>
                    <TextInput
                      label=""
