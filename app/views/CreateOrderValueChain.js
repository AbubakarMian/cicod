    ...
    async createOrderFun() {
        ...
        
      {
        ...
        if (this.state.goto_payment_screen == '') {//show_part_payment
            ...
            this.props.route.params.heading=='supplier' ?this.props.navigation.navigate(this.state.goto_payment_screen, {
                bodyOrder: bodyOrder,
                heading:'supplier',
                ...
                <ScrollView>
                    <View style={{ paddingBottom: 20 }}>
                        ...
                        {(this.props.route.params.screen_name == 'buy') ?
                            ...
                            : null}
                        <View style={[ styles.customerContainerView,{paddingVertical: 10}]}>
...
:<CustomerDetail currency={this.props.currency.currency} name={this.props.customer.name} email={this.props.customer.email} phone={this.props.customer.phone} />
                        ...
                        <TouchableOpacity
                            onPress={() => this.props.navigation.navigate('AddProductValueChain',{heading:"supplier",item:this.state.supplier})}
                        >
                        ...
                        <View style={[{}, styles.OrderDetailContainer]}>
                            ...
                            {(this.state.cart_arr.length == 0) ?
                                <NoOrderDetail />
                                : <OrderDetail currency={this.props.cart.currency} carts={this.state.cart_arr} counterFun={this.counterFun} removeProduct={this.removeProduct}  />
                        ...
                        <View style={[{}, styles.paymentContainerView]}>
                            ...
                            <View style={[{}, styles.radioFormView]}>
                                <RadioForm
                                    ...
                                    initial={0}
                                    style={{}}
                                    onPress={(value) => { this.setState({ value3IndexPayment: value }) }}
                                    // onPress={() => this.DeliveryType('delivery')}
                                />
                                {
                                    radio_props_payment.map((obj, i) => (
                                        <RadioButton
                                            ...
                                            <RadioButtonInput
                                                ...
                                                borderWidth={1}
                                                buttonInnerColor={'#e74c3c'}
                                                buttonOuterColor={this.state.value3IndexPayment === i ? '#2196f3' : '#000'}
                                                buttonSize={10}
                                                buttonOuterSize={20}
                                                buttonStyle={{}}
                                                buttonWrapStyle={{ marginLeft: 10 }}
