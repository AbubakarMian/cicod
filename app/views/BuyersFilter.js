      ...
      <Scaffold>
        <View style={[{}, styles.mainView]}>
          ...
          /> */}
            ...
            <Text
              style={[
                {color: '#D8D8D8', position: 'absolute', right: 20, top: 20},
                fontStyles.normal15,
              ]}>
              Clear Filter
            </Text>
          ...
          <View
            style={[{flexDirection: 'row', width: width / 2, zIndex: -0.999}]}>
            <View style={[{flex: 1, paddingVertical: 10}]}>
              <Text style={[{color: '#929497'}, fontStyles.bold15]}>
                Approved Date
              </Text>
              <TouchableOpacity onPress={() => this.datePickerFun()}>
                <View
                  style={{
                    backgroundColor: '#fff',
                    flexDirection: 'row',
                  ...
                  <Text
                    ...
                    {this.state.date == '' ? 'DD-MM-YY' : this.state.date}
                  </Text>
                </View>
                <View style={{position: 'absolute', right: 20, bottom: 15}}>
                  <Icon size={25} name="caret-down" color={'#707070'} />
                </View>
              </TouchableOpacity>
            </View>
          </View>
