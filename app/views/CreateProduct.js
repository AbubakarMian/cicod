            ...
            <View style={[{}, styles.mainView]}>
                ...
                <View style={[{}, styles.backRowView]}>
                    ...
                    <View style={[{}, styles.backRowHeadingView]}>
                        <Text style={[{}, styles.backRowHeadingText]}>{this.props.route.params.action=='create'?'CREATE PRODUCT':'UPDATE PRODUCT'}</Text>
                    </View>
                </View>
                </TouchableOpacity>
                <ScrollView>
                    <View>
                        <View style={[{}, styles.productDetailContainerView]}>
                                ...
                                <View style={[ { position: 'relative',width:"100%",borderBottomColor:"#E6E6E6",borderBottomWidth:1 }]}>
                                        <Picker
