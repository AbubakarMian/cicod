...
class ConnectView extends React.Component {
    ...
    fetch(url, postData)
      ...
      .then(async responseJson => {
        ...
        if (responseJson.success === true) {
          ...
          console.log(
            ' responseJson.responseJson.data buyer data  !!!!!!!!!!!!!!!',
            responseJson.data,
          );
  ...
  declineRequest() {
    ...
    let url =
      Constants.decline_request + '?id=' + this.props.route.params.item.id;
    console.log('***********', url);
    let postData = {
      method: 'POST',
      headers: {
  ...
  render() {
    console.log(
      'this.state.buyer_data this.state.buyer_data: ',
      this.state.buyer_data,
    );
    ...
    return (
      <Scaffold>
        <View style={[{}, styles.mainView]}>
            ...
            <TouchableOpacity
              onPress={() =>
                this.props.navigation.navigate('UpdateProduct', {
                  buyer_detail: this.state.buyer_data,
                  screen: 'buyer',
          ...
          <Modal visible={this.state.productImageModal} transparent={true}>
              ...
              <View style={[styles.suspendmodalBackGround]}>
                <TouchableWithoutFeedback>
                  <View
                    ...
                    />
                    <Text style={[{color: '#4E4D4D'}, fontStyles.normal15]}>
                      You are about to Decline
                    </Text>
                    <View style={{flexDirection: 'row'}}>
                      <Text style={[{color: '#4E4D4D'}, fontStyles.bold18]}>
                        {this.state.buyer_name}
                      </Text>
                      <Text
                        style={[
                          {color: '#4E4D4D', paddingTop: 3},
                          fontStyles.normal15,
                        ]}>
                        {' '}
                        request
