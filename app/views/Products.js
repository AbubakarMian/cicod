...
import { View, TouchableHighlight,TouchableWithoutFeedback,Modal as OtherModal, FlatList, Dimensions, Alert, Image, Platform, TouchableOpacity, ScrollView, } from 'react-native';
...
class Products extends React.Component {
    ...
    onCategoryText(category_id) {
        ...
        let url =category_id==""? Constants.productslist : Constants.productslist + '?category_id=' + category_id;
        this.getData(url);
    }
        ...
        return (
            <View style={{width:width,
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: "space-around" }}>
                    ...
                    <View  style={{}}>
                    <NavBack title="PRODUCTS" onClick={()=>this.props.navigation.goBack()} />
                    </View>
                ...
                <View style={{ marginBottom: 5, flexDirection: 'row', width: width - 20, alignSelf: 'center', borderRadius: 5, marginTop: 3, alignItems: 'center' }}>
                    <Searchbar
                        placeholder="Search product, Price and code"
                        style={[{ color: '#D8D8D8' }, fontStyles.normal14]}
                        iconColor="#929497"
                        style={{ width: width / 1.3, alignSelf: 'center', elevation: 0, borderColor: '#D8DCDE' }}
                ...
                <View style={[{}, styles.formRowView]}>
                    <View style={[{ position: 'relative',  borderBottomColor:"#E6E6E6",borderBottomWidth:1}, styles.formColumn]}>

                    <Picker
                                        
                    onValueChange={(itemValue,itemLabel, itemIndex) =>this.onCategoryText(itemValue)
                        }
                    selectedValue={this.state.category_id} >
                        <Picker.Item style={{fontSize:15}} color="#929497" label="Product Category" value="" />
                        {this.state.categoryarr.map(elem=>{
                            
                            return  <Picker.Item style={{fontSize:13}} color="#929497" label={elem.label} value={elem.value} />
                        })}
                    </Picker>
                    ...
                    <View style={{ width: width - 20, alignSelf: 'center', marginVertical: 5 }}></View>
                </View>
                    ...
                    >
                        <View style={[{}, styles.modalBackGround]}>
                            ...
                            <View style={styles.suspendModal}>
                                ...
                                <TouchableOpacity
                                 onPress={() => this.setState({isShowModal:false},()=>{
                                    this.props.navigation.navigate('CreateProduct', { action: 'create', prodDetail: null })
                                 }) }
                                ...
                                />
                            <TouchableOpacity
                                onPress={() =>this.setState({isShowModal:false},()=>{ this.props.navigation.replace('CreateProductCategory', { action: 'create'})})}
                                style={[{marginLeft:7}, styles.suspendTouch]}>
                                
                                <Text style={{color:"#4E4D4D"}}>Add Product Category</Text>
                            </TouchableOpacity>
                            </View>
