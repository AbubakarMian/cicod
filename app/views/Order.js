...
import { SET_USER, SET_CUSTOMER, LOGOUT_USER, CLEAR_ORDER, ORDER_RELOAD } from '../redux/constants/index';
            ...
            <View style={{ width: width, height: height, position: 'relative', backgroundColor: '#F0F0F0', flex: 1 }}>
                <View style={{ height: height / 3.1 }}>
                    ...
                    <View style={{ flexDirection: 'row', alignContent: 'center', alignItems: 'center', width: width - 20, alignSelf: 'center' }}>
                        <View>
                            <Text onPress={()=>this.props.navigation.goBack()} style={[{ color: '#2F2E7C', fontWeight: '700' }, fontStyles.normal15]}>ORDER</Text>
                        </View>
                        <View style={{ flex: 1 }}>
                            <TouchableOpacity
