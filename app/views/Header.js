...
import Icon from 'react-native-vector-icons/dist/FontAwesome';
 class Headet extends React.Component {
    ...
    render() {
        console.log("ruiio#$",this.props.route)
     const that=this;
        ...
        return (
            ...
            {this.props.name?(
              ...
              <View style={{flex:8, justifyContent:'center',alignItems:'flex-start',alignSelf:'center'}}>
                 {/* <Image
                 style={{height:30,width:120}} 
                 source={require('../images/headerLogo.png')}
                 /> */}
                 <Text style={{color:"#343A40",fontWeight:"bold",fontSize:16}}>{this.props.user.tenantId.toUpperCase()}</Text>
              </View>
