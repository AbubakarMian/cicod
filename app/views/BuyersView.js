...
console.log("ressss@###",url,postData)
    ...
    render() {
        ...
        return (
          ...
          confirmButtonColor={this.state.isShowAlertSuccess?"#33A354":'#B1272C'}
          onCancelPressed={() => {
                ...
                <TouchableOpacity
                    ...
                    <View style={[{}, styles.backRowView]}>
                        ...
                        <View style={[{}, styles.backRowHeadingView]}>
                            <Text style={[{}, styles.backRowHeadingText]}>{this.props.route.params.heading=="BUYERS"?"RESELLERS":this.props.route.params.heading}</Text>
                        </View>
                    </View>
                    </TouchableOpacity>
                    <View style={{ backgroundColor: '#fff' }}>
                        ...
                        <View style={[{ borderWidth: 0.2, width: width - 30, marginVertical: 1, alignSelf: 'center' }]}></View>
                        <View>
                        ...
                        <View style={[{}, styles.productDetailROwView]}>
                            ...
                            <View style={[{}, styles.columnView]}>
                                ...
                                <Text style={[{}, styles.darkGrayBoldText]}> <NumberFormat decimalScale={2} renderText={(value, props) => <Text style={styles.darkGrayBoldText} {...props}>{value}</Text>} value={this.state.items.value_of_orders} displayType={'text'} thousandSeparator={true}  prefix={this.state.items.seller_currency==null?"":this.state.items.seller_currency.symbol}/> </Text>
                            </View>
                        </View>
                        {(this.props.route.params.heading == 'BUYERS') ?
                            <View style={[{}, styles.productDetailROwView]}>
                                <View style={[{}, styles.columnView]}>
                                    ...
                                    <Text style={[{}, styles.darkGrayBoldText]}>{this.state.items.seller_currency==null?"":this.state.items.seller_currency.symbol} {this.state.items.minimum_spend}</Text>
                                </View>
                                <View style={[{}, styles.columnView]}>
                                </View>
                                <View style={[{}, styles.columnView]}>
                  ...
                  width-80
                    ...
                    {(this.state.orderList.length>0 || this.state.isSearch || this.state.is_active_list!="")&&<>
...
<View style={{ flexDirection: 'row', backgroundColor: '#fff', alignItems: 'center', height: 50, paddingHorizontal: 10, borderRadius: 5, width: width - 25 }}>
    ...
    <TextInput
        ...
        alignSelf={'center'}
        color={'#000'}
        onChangeText={text => this.setState({ search_order: text ,is_active_list:"yea"})}
                    ...
                    >
                        <View style={[{}, styles.modalBackGround]}>
                            ...
                            <TouchableOpacity
                                ...
                                <Text style={{}}> {this.state.is_active?'Suspend':"Unsuspend"}</Text>
                            </TouchableOpacity>
