                ...
                axios.post(url,
                    ...
                    .then(function (response) {
                        ...
                        if (response.data.status === 'success') {
                            ...
                            _that.setState({ isMessage: true,message_text:"Product Category Created Successfully" })
...
<AwesomeAlert
        ...
        />
    <NavBack onClick={() => this.props.route.params&& this.props.route.params.action=="create"? this.props.navigation.goBack():this.props.navigation.navigate("CreateProduct",{action: 'create', prodDetail: null})} title={this.props.route.params.items == null?'CREATE PRODUCT CATEGORY':'EDIT PRODUCT CATEGORY'  } />
