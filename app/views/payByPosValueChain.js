...
class PayByPOSValueChain extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      order_detail: null,
  ...
  get_order_detail() {
    ...
    let order_id = this.props.route.params.data.cicod_order_id;
    console.log('%%%%%%%%%%%%', order_id);
    const url =
      this.props.route.params.heading == 'supplier'
        ? `
        ${Constants.viewSellerOrder}?id=${this.props.route.params.seller_id}&orderId=${this.props.route.params.data.cicod_order_id}`
...
export default connect(mapStateToProps, mapDispatchToProps)(PayByPOSValueChain);
