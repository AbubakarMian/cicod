...
class MakePayment extends React.Component {
  ...
  async setPaymentMode(payment_mode, navigateScreen) {
    ...
    if (this.props.route.params.pending_order_res != undefined) {
      console.log(
        '****************RRRRRRRR',
        this.props.route.params.pending_order_res.data,
      );
      ...
      const paramBpdy =
        this.props.route.params.heading == 'supplier'
          ? {
              ...
              order_id: this.props.route.params.pending_order_res.data.order_id,
            }
          : {
              bodyOrder: this.props.route.params.bodyOrder,
              amount_payable: this.props.route.params.amount_payable,
      ...
      console.log(
        '1111111111111 setPaymentMode body params list @@@@@@!!!!!!!!!!!!!!',
        postData,
      );
      fetch(Constants.orderslist, postData)
        ...
        .then(async responseJson => {
          ...
          if (responseJson.status == 401) {
            ...
            this.payment_response(responseJson, navigateScreen, params);
          } else {
  ...
  async makePaymentFun(payment_mode) {
    ...
    console.log(
      'pending_order_res.data.payment_link 121212121212',
      pending_order_res,
    );
    ...
    if (pending_order_res != null) {
      ...
      this.payment_response(pending_order_res, 'PaymentWeb', params);
      return;
    }
    console.log('here');
  ...
  payByCash() {
    ...
    if (this.props.route.params.pending_order_res == undefined) {
      ...
      this.props.navigation.navigate('PayByCash', {
        ...
        payment_link: this.props.route.params.pending_order_res.data
          .payment_link,
        payment_mode: 'CASH',
                ...
                <TouchableOpacity
                  onPress={
                    ...
                    () =>
                      this.props.navigation.navigate(
                        ...
                        {
                          bodyOrder: this.props.route.params.bodyOrder,
                          amount_payable: this.props.route.params
                            .amount_payable,
                          data: this.props.route.params.pending_order_res,
                          payment_mode: 'USSD',
                  ...
                  <View>
                    <View>
                      ...
                      <Text style={[{}, styles.cardDescText]}>
                        Make payment using Bank USSD code
                      </Text>
                    </View>
                  </View>
                  <View style={[{}, styles.cardImageView]}>
