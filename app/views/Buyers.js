...
class Buyers extends React.Component {
  ...
  search() {
    let search_url =
      Constants.buyerlist + '?filter[buyer_name]=' + this.state.search_buyers;
  ...
  unsuspendBuyer(buyer_id) {
    this.setState({spinner: true, refreshlist: true});
    let postData = {
      method: 'GET',
      headers: {
        Accept: 'application/json',
                ...
                <View style={[{}, styles.flatCardView]}>
                  <View
                    ...
                    <View style={[{}, styles.cardContentView]}>
                      <Text style={[{}, styles.cardContentDarkText]}>
                        {item.buyer_name}
                      </Text>
                      <Text style={[styles.lightGrayText, {flex: 1}]}>
                        ...
                        <TouchableOpacity
                          ...
                          <Menu>
                            ...
                            <MenuOptions>
                              <MenuOption
                                onSelect={() =>
                                  _that.props.navigation.navigate(
                                    'UpdateProduct',
                                    {
                                      buyer_detail: item,
                              ...
                              <MenuOption
                                onSelect={() => _that.suspendAction(item)}>
                                <View style={{flexDirection: 'row'}}>
                                  <Image
    ...
    return (
      <Scaffold>
        <View style={[{}, styles.mainView]}>
          ...
          <ScrollView scrollEnabled={true} horizontal={true} marginTop={10}>
