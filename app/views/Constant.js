...
const auth_url = 'https://api.cicod.com';
const base_url = 'https://com.cicod.com/com/api';
const webshop_url = 'cicod.com/webshop';
const crm_url = 'https://api.cicod.com/crm';
const sass_url = 'https://www.cicod.com';
