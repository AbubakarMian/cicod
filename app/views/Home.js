  ...
  render() {
    ...
    return (
      <View style={{ height: height, width: width, alignItems: 'center', position: 'relative', backgroundColor: '#F0F0F0' }}>
        <Header name={this.props.route.name} navigation={this.props.navigation} />
        <Spinner
          ...
          <View style={{ marginBottom: 40 }}>
            ...
            <View style={[{ flexDirection: 'row', alignSelf: 'center', width: width - 20, alignSelf: 'center', marginTop: 20, alignItems: 'center', justifyContent: 'center', paddingRight: 10 }]}>
              ...
              >
                <View style={[{
                  flexDirection: 'column', width: width / 2 - 80, height: width / 2 - 80,
                  justifyContent: 'center', alignItems: 'center', marginLeft: 7,
                  borderWidth: 1, borderRadius: 10, backgroundColor: '#fff', borderColor: '#fff'
                }]}>
                  <Image
                    style={{ height: width / 8, width: width / 8 }}
            ...
            <TouchableOpacity
              disabled={ this.state.user.kciInfo.showWarning && this.state.user.kciInfo.kciUpdates[0].dayRemaining==0 ?true:false }
                ...
                onPress={() =>{
                  this.setState({countNetwork:0},()=>this.props.navigation.navigate('Network'))
              ...
              >
                <View style={[{
                  ...
                  />
                  <Text style={[{}, styles.cardLableText]}>Quick Invoice</Text>
                </View>
              </TouchableOpacity>
              <TouchableOpacity
              disabled={ this.state.user.kciInfo.showWarning && this.state.user.kciInfo.kciUpdates[0].dayRemaining==0 ?true:false }
                ...
                onPress={() => {
                  ...
                  this.setState({modalInfoType:"delivery",modalInfoTextMore:"Create and your delivery rate on the web",modalInfo:true,modalInfoText:"Your delivery rate card is only accessible on the web",})
                }}
              >
                <View style={[{
                  flexDirection: 'column',width: width / 2 - 80, height: width / 2 - 80,
            ...
            <TouchableOpacity
              disabled={ this.state.user.kciInfo.showWarning && this.state.user.kciInfo.kciUpdates[0].dayRemaining==0 ?true:false }
                ...
                onPress={() => this.setState({modalInfoType:"finance",modalInfoTextMore:"Finace coming soon...",modalInfo:true,modalInfoText:"",})
              }
              >
                <View style={[{
                  flexDirection: 'column',width: width / 2 - 80, height: width / 2 - 80,
              ...
              disabled={ this.state.user.kciInfo.showWarning && this.state.user.kciInfo.kciUpdates[0].dayRemaining==0 ?true:false }
                ...
                onPress={() =>                   this.setState({modalInfoType:"finance",modalInfoTextMore:"Manage accounting on the web",modalInfo:true,modalInfoText:"",})
              }
              >
                <View style={[{
                  flexDirection: 'column',width: width / 2 - 80, height: width / 2 - 80,
              ...
              disabled={ this.state.user.kciInfo.showWarning && this.state.user.kciInfo.kciUpdates[0].dayRemaining==0 ?true:false }
                ...
                onPress={() =>                   this.setState({modalInfoType:"adduser",modalInfoTextMore:"To add more users to your account, go on the web",modalInfo:true})
              }
              >
                <View style={[{
                  flexDirection: 'column',width: width / 2 - 80, height: width / 2 - 80,
            ...
            <View style={[{ flexDirection: 'row', alignSelf: 'center', width: width - 20, alignSelf: 'center', marginTop: 20, alignItems: 'center',  paddingRight: 10 }]}>
              <Text style={{color:"#2F2E7C",fontWeight:"bold",justifyContent:"flex-start",textAlign:"left"}}>Click the link to access webshop</Text>
                
            </View>
            <View style={[{ flexDirection: 'row', alignSelf: 'center', width: width - 20, alignSelf: 'center', marginTop: 10, alignItems: 'center',  paddingRight: 10 }]}>
                  <TouchableOpacity onPress={()=>this.veiwShop()} style={{flexDirection:'row',padding:10,backgroundColor:"#FFFFFF",height:44,width:"75%",marginRight:9,borderRadius:5,justifyContent:"space-between"}}>
                
                    <Text style={{fontSize:10,color:"#007BFF",fontWeight:"bold"}}>{`https://${this.state.tenantId.toLowerCase()}.${Constants.webshop_url}`}</Text>
                    <Image
                    
                    source={require('../images/home/share_alt.png')}
                  />
               
                </TouchableOpacity>
                <TouchableOpacity onPress={()=>this.shareShop()} style={{paddingLeft:15,paddingRight:15,height:44,width:"25%",backgroundColor:"#2F2E7C",borderRadius:5,justifyContent:"space-between",alignItems:"center",flexDirection:"row"}}>
                <Image
        ...
        <OtherModal
                ...
                >
                    ...
                    <View
                        style={{height:height-250, alignSelf: 'center', backgroundColor: '#fff', width: width - 50, justifyContent: 'center', alignItems: 'center', paddingVertical: 20,padding:30, borderRadius: 10, flexDirection: 'column' }}
                    >
                      ...
                      {this.state.modalInfoType=="accounting" &&(
                       ...
                       <Text style={{fontWeight:"bold",color:"#4E4D4D",fontSize:20}}>{this.state.modalInfoText}</Text>
                        <Text style={{color:"#4E4D4D",marginTop:16}}>{this.state.modalInfoTextMore}</Text>
