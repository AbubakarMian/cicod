...
import CreateQuickInvoice from './CreateQuickInvoice';
import AddCustomerInvoice from './AddCustomerInvoice';
import Network from './Network';
import payByPosValueChain from './payByPosValueChain';
    ...
    return (
      <NavigationContainer>
        <Stack.Navigator initialRouteName="Splash">
          ...
          />
          <Stack.Screen
            name="BuyDiliveryAddress"
            component={BuyDiliveryAddress}
            options={{headerShown: false}}
          />
          <Stack.Screen
            name="BuyDiliveryAddressValueChain"
            component={BuyDiliveryAddressValueChain}
            options={{headerShown: false}}
          />
          ...
          />
          <Stack.Screen
            name="OrderDetailValueChain"
            component={OrderDetailValueChain}
            options={{headerShown: false}}
          />
          <Stack.Screen
            name="OrderDetail_pending"
            component={OrderDetail_pending}
            options={{headerShown: false}}
          />
          <Stack.Screen
            name="OrderFilter"
          ...
          />
          <Stack.Screen
            name="CreateOrderValueChain"
            component={CreateOrderValueChain}
            options={{headerShown: false}}
          />
          <Stack.Screen
            name="MakePayment"
          ...
          />
          <Stack.Screen
            name="PayByPosValueChain"
            component={payByPosValueChain}
            options={{headerShown: false}}
          />
          <Stack.Screen
            name="PayByCash"
          ...
          />
          <Stack.Screen
            name="PayByUssdValueChain"
            component={PayByUssdValueChain}
            options={{headerShown: false}}
          />
          <Stack.Screen
            name="AddProduct"
          ...
          />
          <Stack.Screen
            name="AddProductValueChain"
            component={AddProductValueChain}
            options={{headerShown: false}}
          />
          <Stack.Screen
            name="ApplyDiscount"
          ...
          <Stack.Screen
            name="BuyCreateOrder"
            component={BuyCreateOrder}
            options={{headerShown: false}}
          />
          <Stack.Screen
            name="DiliveryAddress"
            component={DiliveryAddress}
            options={{headerShown: false}}
          />
          <Stack.Screen
            name="PickUpLocation"
          ...
          />
          <Stack.Screen
            name="AddDiliveryAddress"
            component={AddDiliveryAddress}
            options={{headerShown: false}}
          />
          <Stack.Screen
            name="AddSuppliers"
