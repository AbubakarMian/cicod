...
{/* 
          ...
          <Stack.Screen name="PayByPosValueChain" component={payByPosValueChain} options={{ headerShown: false }} />
          ...
          <Stack.Screen name="QuickInvoice" component={QuickInvoice} options={{ headerShown: false }} />
          <Stack.Screen name="CreateQuickInvoice" component={CreateQuickInvoice} options={{ headerShown: false }} />
          <Stack.Screen name="AddCustomerInvoice" component={AddCustomerInvoice} options={{ headerShown: false }} />
