...
class Login extends React.Component {
  constructor(props) {
    ...
    this.state = {
      Spinner: false,
      tenantId: '', // rico  //ndanitv
      username: '', // rico@yopmail.com  //ndanitv@sharklasers.com
      password: '', // @Ecomax1759 //@Ecomax1759
      isChecked: false,
      hide_password: true,
  ...
  async componentDidMount() {
    let remember_credentials = await AsyncStorage.getItem(
  ...
  setCurrency(user_token) {
    ...
    fetch(Constants.currency, postData)
      ...
      .then(async responseJson => {
        ...
        console.log(
          'responseJson.data.symbol Json currency!!!!!!!!!!!',
          responseJson.data.symbol,
        );
      ...
      <KeyboardAwareScrollView
        ...
        <View style={[{position: 'relative'}, styles.mainView]}>
          ...
          <View
            ...
            <View
              ...
              <TextInput
                ...
                onBlur={() => {
                  this.setState({domain_text_color: 'black'});
                }}
                width={width - 50}
                height={height / 12}
          ...
          <TouchableOpacity
            ...
            <Text
              style={{color: '#FFFFFF', fontSize: 16, fontFamily: 'Open Sans'}}>
              Continue
            </Text>
          </TouchableOpacity>
