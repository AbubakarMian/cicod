  ...
  successview(props) {
    ...
    return (
      <View style={[{}, styles.mainContainer]}>
        <View
          style={{borderColor: '#DAF8EC', borderWidth: 20, borderRadius: 100}}>
          <Image
        ...
        <TouchableOpacity
          onPress={() => {
            _that.props.clearCart({reload: true}),
              _that.props.route.params.heading == 'supplier'
                ? _that.props.navigation.navigate('OrderDetailValueChain', {
                    order_id: _that.props.route.params.order_id,
                    seller_Id: _that.props.route.params.seller_id,
                    heading: 'SUPPLIERS',
                  })
                : _that.props.navigation.navigate('OrderDetail', {
                    id: order.id,
                  });
          }}
    ...
    if (order != status) {
      return (
        <View style={[{}, styles.mainContainer]}>
          ...
          <Text style={[{color: '#4E4D4D', marginTop: 10}, fontStyles.bold25]}>
