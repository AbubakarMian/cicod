                ...
                <ScrollView>
                    <View>
                        ...
                        <TouchableOpacity
                            ...
                            <View style={[{}, styles.cardTextView]}>
                                <Text style={[{ color: '#4E4D4D' }, fontStyles.bold15]}>Resellers</Text>
                                <Text style={[{ color: '#929497' }, fontStyles.normal12]}>List of all your resellers</Text>
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity
                        ...
                        <TouchableOpacity
                            ...
                            <View style={[{}, styles.cardTextView]}>
                                <Text style={[{ color: '#4E4D4D' }, fontStyles.bold15]}>Network</Text>
                                <Text style={[{ color: '#929497' }, fontStyles.normal12]}>See List of Merchants to Connect</Text>
                            </View>
                        </TouchableOpacity>
                        ...
                        <TouchableOpacity
                            ...
                            <View style={[{}, styles.cardTextView]}>
                                <Text style={[{ color: '#4E4D4D' }, fontStyles.bold15]}>Quick Invoice</Text>
                                <Text style={[{ color: '#929497' }, fontStyles.normal12]}>Send Quick Invoice </Text>
                            </View>
                        </TouchableOpacity>
                        ...
                        <TouchableOpacity
                           // onPress={() => this.props.navigation.navigate('Connect')}
                            ...
                            <View style={[{}, styles.cardTextView]}>
                                <Text style={[{ color: '#4E4D4D' }, fontStyles.bold15]}>Support</Text>
                                <Text style={[{ color: '#929497' }, fontStyles.normal12]}>Read help articles and watch help videos </Text>
                            </View>
                        </TouchableOpacity>
                        ...
                        <TouchableOpacity
                            ...
                            <View style={[{}, styles.cardTextView]}>
                                <Text style={[{ color: '#4E4D4D' }, fontStyles.bold15]}>Account</Text>
                    ...
                    <View style={{marginTop:10,marginBottom:20,width:"70%",justifyContent:"center",alignItems:"center",alignSelf:"center"}}>
                    <Text style={{color:"#929497",letterSpacing:1.0,fontSize:10}}>
                        CICOD Customer Order Management Mobile App is a product of Crown Interactive    
                    </Text>
                    <Text style={{color:"#929497",fontWeight:"bold",marginTop:20,marginBottom:20}}>Version 1.0</Text>
                    <Text style={{color:"#B1272C",fontSize:13,fontWeight:"bold"}}>A PRODUCT OF CROWN INTERACTIVE</Text>
                    </View>
