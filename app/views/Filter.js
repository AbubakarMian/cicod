        ...
        <View style={[{}, styles.mainView]}>
          ...
          <View style={{zIndex: -0.999}}>
            <View style={{paddingVertical: 20}}>
              <Text
                style={[{color: '#929497', fontWeight: 'bold', fontSize: 18}]}>
                Status:
              </Text>
            </View>
            <View>
                ...
                <View style={[{marginRight: 10}]}>
                  <TouchableOpacity onPress={() => this.activeSet(1)}>
                    <Text
                      style={[
                        {
                          color: this.state.active == 1 ? '#fff' : '#929497',
                          borderRadius: 50,
                          padding: 7,
                          backgroundColor:
                            this.state.active == 1 ? 'green' : '#E6E6E6',
                          paddingHorizontal: 5,
                        },
                      ]}>
                      ACTIVE{' '}
                ...
                <View style={[{}]}>
                  <TouchableOpacity onPress={() => this.activeSet(0)}>
                    <Text
                      style={[
                        {
                          color: this.state.active == 0 ? '#fff' : '#929497',
                          padding: 7,
                          borderRadius: 50,
                          backgroundColor:
                            this.state.active == 0 ? 'green' : '#E6E6E6',
                          paddingHorizontal: 5,
                        },
                      ]}>
                      IN ACTIVE{' '}
