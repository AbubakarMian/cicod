          ...
          <ScrollView>
            <View>
              ...
              <View style={[{}, styles.customerDetailView]}>
                <Text style={[{}, styles.customerDetailHeadingText]}>
                  Customer Details
                </Text>
                <View style={[{}, styles.customerDetailRow]}>
                  <Icon name="user-circle" color={'#929497'} size={15} />
                  <Text style={[{}, styles.customerDetailNameText]}>
                    BridgeBuy Retail
                  </Text>
                </View>
                <View style={[{}, styles.customerDetailRow]}>
                  <Text style={[{}, styles.customerDetailLable]}>Email: </Text>
                  <Text style={[{}, styles.customerDetailInfo]}>
              ...
              <View style={[{}, styles.OrderDetailContainer]}>
                <Text style={[{}, styles.customerContainerhead]}>
                  Order Detail
                </Text>
                <Image source={require('../images/cartSlash.png')} />
                <Text style={[{}, styles.OrderDetailContainerHeadingText]}>
                  No product added
                </Text>
                <Text style={[{}, styles.OrderDetailContainerText]}>
                  Add a product
                </Text>
              </View>
              ...
              <View style={[{}, styles.paymentContainerView]}>
                <Text style={[{}, styles.paymentHeadingText]}>
                  Payment Options
                </Text>
                <View style={[{}, styles.radioFormView]}>
                  <RadioForm
                      ...
                      <TouchableHighlight
                        ...
                        <View style={[{}, styles.modalListContainer]}>
                          ...
                          <View style={[{}, styles.modalListContentView]}>
                            <Text style={[{}, styles.modalBoldeText]}>
                              {item.title}
                            </Text>
