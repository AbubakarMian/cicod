...
class AddNewCustomer extends React.Component {
    ...
    ceateCustomer() {  
        ...
        if (this.props.route.params && this.props.route.params.from=="invoice" && this.state.email=="") {
        ...
        return (
            <View style={[{}, styles.mainView]}>
                ...
                <View style={[{}, styles.backRowView]}>
                    <NavBack title="ADD NEW CUSTOMER" onClick={()=>this.props.navigation.goBack()} />
                </View>
                <ScrollView>
                    <View>
                        <View style={[{}, styles.mainFormView]}>
                            ...
                            />
                            <TextInput
                                label={`Email${this.props.route.params && this.props.route.params.from=="invoice"?'*':''}`}
                                style={{ backgroundColor: 'transparent', }}
                                width={width - 50}
                                alignSelf={'center'}
                                color={'#000'}
